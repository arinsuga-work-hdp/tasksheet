...
convert(year(a.tgl), char(4)) AS absensi_year,
convert(month(a.tgl), char(2)) AS absensi_month,
convert(concat(cast(year(a.tgl) as char),lpad(month(a.tgl),2,0)), char(6)) AS absensi_yearmonth,
